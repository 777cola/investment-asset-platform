...
export function renderAdminMenu(state, t) {
  ...
  const modules = [
    ...
    { icon: "📊", key: "asset-overview", title: t("assetOverview"), desc: t("assetOverviewMenuDesc") },
    { icon: "📈", key: "value-update", title: t("valueUpdate"), desc: t("valueUpdateDesc") },
    { icon: "💵", key: "interest-records", title: t("interestCommissionPayout"), desc: t("interestCommissionPayoutDesc") },
